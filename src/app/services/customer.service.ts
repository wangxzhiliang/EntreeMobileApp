...
export class CustomerService {
  ...
  likeReview(reviewId: number): Observable<string> {
    return this.httpClient.get<string>("/api/Review/addCustomerToLikeList?customerId=" + this.sessionService.getCurrentCustomer().userId + "&reviewId=" + reviewId).pipe
      (
        catchError(this.handleError)
      );
  }
